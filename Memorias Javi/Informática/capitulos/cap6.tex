...
\begin{figure}[H]
	\centering
	\subfloat[Partidos]{
		\includegraphics[width=0.4\textwidth]{images/comp_temp_mod1_part.png}}\\
	\subfloat[Ranking]{
		\includegraphics[width=0.4\textwidth]{images/comp_temp_mod1_rank.png}}	
	\subfloat[Tau de Kendall]{
		\includegraphics[width=0.4\textwidth]{images/comp_temp_mod1_tau.png}}
...
\begin{figure}[H]
	\centering
	\subfloat[Partidos]{
		\includegraphics[width=0.4\textwidth]{images/comp_temp_mod3_part.png}}\\
	\subfloat[Ranking]{
		\includegraphics[width=0.4\textwidth]{images/comp_temp_mod3_rank.png}}	
	\subfloat[Tau de Kendall]{
		\includegraphics[width=0.4\textwidth]{images/comp_temp_mod3_tau.png}}
