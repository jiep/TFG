...
Notar que en este caso se producen empates. Para romperlos se pueden seguir varias estrategias:

\todo[backgroundcolor=red, inline]{Añadir estrategias para romper empates}
...
\begin{tabular}{@{}cccc@{}}
\multicolumn{1}{l}{} & \multicolumn{1}{l}{$\mathbf{r}$} & \multicolumn{1}{l}{Ranking} & \begin{tabular}[c]{@{}c@{}}Diferencia \\ de puntos\end{tabular} \\ \cmidrule(r){1-3}
DEN                  & 0.3571                           & 5                           & -38                                                             \\
LAL                  & 0.3571                           & 4                           & -18                                                             \\
SAS                  & 0.6429                           & 2                           & 21                                                              \\
CHI                  & 0.5                              & 3                           & 11                                                              \\
NYK                  & 0.6429                           & 1                           & 24                                                              \\ \cmidrule(r){1-3}
\end{tabular}
\end{table}
