...
\left(\begin{array}{cc}
\dfrac{1}{3} + \dfrac{2}{3 \cdot 4^n} & \dfrac{2}{3} - \dfrac{2}{3 \cdot 4^n} \\
\dfrac{1}{3} - \dfrac{1}{3 \cdot 4^n} & \dfrac{2}{3} + \dfrac{1}{3 \cdot 4^n}
\end{array}\right)
\end{align*}
...
\todo[backgroundcolor=red, inline]{Añadir clasificación de las cadenas de Markov}