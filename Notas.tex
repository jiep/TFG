	...
	\begin{itemize}
		...
		\item Medidas de competitividad:
			\begin{itemize}
				...
				\begin{nota}
					Se pueden considerar otros parámetros de grafos (ver Ref. 25). Todos estos parámetros consideran que una familia de rankings es más competitiva que otra si el parámetro en el grafo de competitividad evolutivo es mayor. \\
					Otros parámetros, lo consideran al revés, como el coeficiente de correlación $\tau$ de Kendall generalizado.
				\end{nota}
				\item Coeficiente de correlación $\tau$ de Kendall generalizado.
			\end{itemize}
		\item Medidas clásicas de equilibrio de  competitividad
			\begin{enumerate}
				\item Desviación típica de la proporción de victorias (de un equipo a lo largo de la temporada).
				\item NAMSI (National Measure of Seasonal Imbalance)
				\item HICB (H-index of competitive balance) 
				\item Churn
				\item Adjusted Churn
			\end{enumerate}
	\end{itemize}
