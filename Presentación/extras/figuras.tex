...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,semithick]
  ...
  \node[state] (nyk)                {1};
  \node[state] (sas) [right of=nyk] {2};
  \node[state] (chi) [right of=sas] {3};
  \node[state] (lal) [right of=chi] {4};
  \node[state] (den) [right of=lal] {5};  
...
\begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=3cm,semithick]
  ...
  \node[state] (por)                      {2};
  \node[state] (ock) [below right of=por] {3};
  \node[state] (den) [below       of=ock] {1};
  \node[state] (min) [below left  of=por] {5};
  \node[state] (uta) [below       of=min] {4};  
